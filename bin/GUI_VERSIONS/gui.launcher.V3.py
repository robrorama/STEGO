...
V3 Updates: Hierarchical TreeView, Search Filtering, Scrollbars.
"""
...
# STRUCTURE CHANGE:
# The Dictionary is now Nested: { "Category Name": { "Script Name": { config... } } }
SCRIPTS_CONFIG = {
    "Technical Analysis": {
        "Peak/Trough I-Bars": {
        ...
        "Head & Shoulders Pattern": {
         ...
         "Adaptive Anchored VWAP": {
            ...
            "args": [
                ...
                {"name": "--plot", "type": "check", "label": "Generate & Show Plot", "default": "on"},
    ...
    "Volume Analysis": {
        "Volume Visualizer": {
            ...
            "args": [
                {"name": "ticker", "type": "entry", "label": "Ticker:", "positional": True},
                {"name": "period_or_start", "type": "entry", "label": "Period/Start (YYYY-MM-DD):", "positional": True, "default": "1y"},
    ...
    "Comparisons & Correlations": {
         "Ratio Comparison (Clickable)": {
            ...
            "args": [
                ...
                {"name": "--clickable", "type": "check", "label": "Enable Clickable Lines"},
            ]
        },
...
class ScriptLauncherGUI:
    def __init__(self, master):
        self.master = master
        self.master.title("Financial Scripts Launcher V3")
